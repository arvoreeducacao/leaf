  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        className={cn(
          'pointer-events-none absolute top-1/2 size-5 -translate-y-1/2 rounded-full border border-gray-400 bg-white shadow-down-small transition-[left] duration-200 data-[state=checked]:left-[13px] data-[state=unchecked]:-left-1'
        )}
